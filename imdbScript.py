# -*- coding: utf-8 -*-
"""IMDB_500_Movie_Database.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CS44QeRcgZGgIRkvWpDZ4MFs4QT_WwyT
...
"""## Bereau of Labor Statistics (BLS) API Call"""
...
main_df[new_col_name] = pd.Series(revenue_current).astype("float64").values

main_df["Rank"] = pd.Series(list(range(1, 501))).values # Add rank information

main_df = main_df[['Rank','Year', 'Rated', 'Released', 'Runtime', 'Genre', 'Director', 'Writer','Actors', 'Plot', 'Language', 'Country', 'Awards', 'Poster','Metascore', 'imdbRating', 'imdbVotes', 'imdbID', 'DVD', 'BoxOffice', new_col_name ,'Production']]

main_df

"""## Output CSV"""

main_df.to_csv("imdb_top_500.csv", sep=",")
